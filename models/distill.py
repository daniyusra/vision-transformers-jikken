...
from models.swin_pool3 import SwinTransformer as SwinPool
...
class DistillablePool(DistillMixin, SwinPool):
    def __init__(self, *args, **kwargs):
        super(DistillablePool, self).__init__(*args, **kwargs)
        self.args = args
        self.kwargs = kwargs
        self.dim = kwargs['dim']
    ...
    def to_vit(self):
        s = SwinPool(*self.args, **self.kwargs)
...
class DistillWrapper(nn.Module):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        assert (isinstance(student, (DistillablePool))) , 'student must be a vision transformer'
