...
class SwinMLPBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, pool_size=3, layer_scale_init_value=1):
        super().__init__()
        self.dim = dim
    ...
    def forward(self, x):
        ...
        #to-try: add transpose here!
        x_windows = x_windows.reshape(-1, C, self.window_size, self.window_size)

        #x_windows = x_windows.transpose(1,3)

        spatial_mlp_windows = self.token_mixer(x_windows)

        #spatial_mlp_windows = spatial_mlp_windows.transpose(1,3)
...
class SwinPoolMLPConv2D(nn.Module):
    r""" Swin MLP
