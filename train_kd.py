...
from utils import load_pretrained, save_checkpoint
...
def main():
	...
	snet = load_model(netname = args.s_name, patch = args.patch, dimhead = args.dimhead, imsize = int(args.size), cuda = args.cuda, num_classes=args.num_class)
	if args.s_init != "":
		checkpoint = torch.load(args.s_init)
		load_pretrained(checkpoint['net'], snet)
	...
	print(args.t_name)
	tnet = load_model(netname = args.t_name, patch = args.patch, dimhead = args.dimhead, imsize = int(args.size), cuda = args.cuda, num_classes=args.num_class)
